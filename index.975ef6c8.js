...
function handleChange(event) {
    const { elements: { message: message1 , email: email1 , name  } ,  } = event.currentTarget;
    if (message1.value.trim() !== "" && email1.value.trim() !== "" && name.value.trim() !== "" && _emailValidator.validate(email1.value) === true) button.removeAttribute("disabled");
}
...
},{"email-validator":"gi6bx"}],"gi6bx":[function(require,module,exports) {
"use strict";
