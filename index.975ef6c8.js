...
var _questionsList = require("./js/questionsList");
var _form = require("./js/form");
var _select = require("./js/select");

},{"./sass/main.scss":"dFl68","./js/slider":"aMYz0","./js/questionsList":"b4ZEJ","./js/form":"l9hyy","./js/select":"8pMAy"}],"dFl68":[function() {},{}],"aMYz0":[function(require,module,exports) {
let counter = 1;
...
let array = document.getElementsByClassName("swiper-slide");
if (counter === 1) {
...
nexbutton.addEventListener("click", function() {
    ...
    if (counter === 4) nexbutton.setAttribute("disabled", true);
    if (counter === 1) prevbutton.classList.add("swiper-disabled");
    if (counter > 1) prevbutton.classList.remove("swiper-disabled");
});
...
},{}],"b4ZEJ":[function(require,module,exports) {
let arrayResponses = Array.from(document.querySelectorAll(".questions__list-item-response"));
let arrayButtons = document.getElementsByClassName("questions__list-buttons");
let arrayButtonsClose = document.getElementsByClassName("questions__list-item-response-button");
let arrayResponsesActive = [];
for(let i = 0; i < arrayButtons.length; i++)arrayButtons[i].addEventListener("click", function() {
    arrayResponses.find((item, index)=>{
        if (i === index && arrayResponsesActive) {
            item.classList.remove("questions__list-item-response");
            item.classList.add("questions__list-item-response-visible");
            arrayResponsesActive.push(item);
        }
        if (index === i && arrayResponsesActive.length === 2) {
            arrayResponsesActive[0].classList.remove("questions__list-item-response-visible");
            arrayResponsesActive[0].classList.add("questions__list-item-response");
            arrayResponsesActive.shift();
        }
        if (arrayResponsesActive.length === 1) {
            arrayResponsesActive[0].classList.remove("questions__list-item-response");
            arrayResponsesActive[0].classList.add("questions__list-item-response-visible");
        }
    });
});
for(let i1 = 0; i1 < arrayButtonsClose.length; i1++)arrayButtonsClose[i1].addEventListener("click", function() {
    arrayResponses.find((item, index)=>{
        if (i1 === index) {
            item.classList.remove("questions__list-item-response");
            item.classList.add("questions__list-item-response-visible");
        ...
        if (index === i1 && arrayResponsesActive.length === 2) {
            arrayResponsesActive[0].classList.remove("questions__list-item-response-visible");
            arrayResponsesActive[0].classList.add("questions__list-item-response");
            arrayResponsesActive.shift();
        }
...
let arrayInputs = document.getElementsByClassName("contact__form-input");
let nameInput = arrayInputs[0];
let email = document.getElementById("mail");
let messageInput = arrayInputs[2];
let button = document.querySelector(".contact__form-button");
let form = document.querySelector(".contact__form-fields");
let wrongValue = document.querySelector(".wrong__input");
if (nameInput.value !== "" && messageInput.value !== "" && email !== "") button.removeAttribute("disabled");
form.addEventListener("submit", handleSubmit);
let message = document.querySelector(".error-invisible");
email.addEventListener("change", onTextareaInput);
function handleSubmit(event) {
    event.preventDefault();
    const { elements: { message , email , name  } ,  } = event.currentTarget;
}
function onTextareaInput(evt) {
    let k = evt.target.value;
    console.log(_emailValidator.validate(k) === true);
    let trigger = false;
    if (_emailValidator.validate(k) === true) {
        email.classList.remove("contact__form-input");
        email.classList.add("correct__input");
        console.log(wrongValue);
    }
    if (_emailValidator.validate(k) === false && wrongValue === null) {
        trigger = true;
        email.classList.remove("contact__form-input");
        email.classList.add("wrong__input");
        console.log(wrongValue);
    }
    if (_emailValidator.validate(k) === true && wrongValue !== null) {
        trigger = true;
        email.classList.remove("wrong__input");
        email.classList.add("correct__input");
        console.log(wrongValue);
    }
    if (trigger === true) message.style.display = "block";
...
},{"email-validator":"gi6bx","lodash/throttle":"lAb0D","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gi6bx":[function(require,module,exports) {
"use strict";
...
const choices = new (0, _choicesJsDefault.default)(selectStateInputEl, {
    searchEnabled: false,
    itemSelectText: ""
});
 ...
 */ var Choices1 = /** @class */ function() {
   ...
   */ Choices.prototype.setChoices = function(choicesArrayOrFetcher, value, label, replaceChoices) {
                    ...
                    Choices.prototype._createItemsFragment = function(items, fragment) {
                        ...
                        var _a1 = this.config, shouldSortItems = _a1.shouldSortItems, sorter = _a1.sorter, removeItemButton = _a1.removeItemButton;
   ...
   */ Input.prototype.setWidth = function() {
            ...
            /***/ 730: /***/ function(__unused_webpack_module, exports, __webpack_require__) {
                ...
                var utils_1 = __webpack_require__(799);
                var WrappedElement1 = /** @class */ function() {
                ...
                exports["default"] = WrappedElement1;
            /***/ },
            /***/ 541: /***/ function(__unused_webpack_module, exports, __webpack_require__) {
                ...
                var WrappedInput1 = /** @class */ function(_super) {
            ...
            /***/ 982: /***/ function(__unused_webpack_module, exports, __webpack_require__) {
                ...
                var wrapped_element_1 = __importDefault(__webpack_require__(730));
                var WrappedSelect1 = /** @class */ function(_super) {
                ...
                exports["default"] = WrappedSelect1;
            /***/ },
            ...
            /***/ },
            /***/ 187: /***/ function(__unused_webpack_module, exports1, __webpack_require__) {
                ...
                __exportStar(__webpack_require__(18), exports1);
                __exportStar(__webpack_require__(978), exports1);
                __exportStar(__webpack_require__(948), exports1);
                __exportStar(__webpack_require__(359), exports1);
                __exportStar(__webpack_require__(285), exports1);
                __exportStar(__webpack_require__(533), exports1);
                __exportStar(__webpack_require__(287), exports1);
                __exportStar(__webpack_require__(132), exports1);
                __exportStar(__webpack_require__(837), exports1);
                __exportStar(__webpack_require__(598), exports1);
                __exportStar(__webpack_require__(369), exports1);
                __exportStar(__webpack_require__(37), exports1);
                __exportStar(__webpack_require__(47), exports1);
                __exportStar(__webpack_require__(923), exports1);
                __exportStar(__webpack_require__(876), exports1);
            /***/ },
 ...
 */ function isArray(value) {
                ...
                function norm1(weight = 1, mantissa = 3) {
                    const cache = new Map();
                ...
                class FuseIndex {
                    constructor({ getFn =Config.getFn , fieldNormWeight =Config.fieldNormWeight  } = {}){
                        this.norm = norm1(fieldNormWeight, 3);
                        this.getFn = getFn;
                ...
                const searchersLen = searchers1.length;
 ...
 */ var legacy_createStore = createStore1;
                /**
 ...
 */ function isCrushed() {}
        ...
        !function() {
            /* harmony import */ var _scripts_choices__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__1(373);
            /* harmony import */ var _scripts_choices__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/ __webpack_require__1.n(_scripts_choices__WEBPACK_IMPORTED_MODULE_0__);
            /* harmony import */ var _scripts_interfaces__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__1(187);
            /* harmony import */ var _scripts_interfaces__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/ __webpack_require__1.n(_scripts_interfaces__WEBPACK_IMPORTED_MODULE_1__);
            /* harmony import */ var _scripts_constants__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__1(883);
            /* harmony import */ var _scripts_defaults__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__1(789);
            /* harmony import */ var _scripts_templates__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__1(686);
            /* harmony default export */ __webpack_exports__1["default"] = _scripts_choices__WEBPACK_IMPORTED_MODULE_0___default();
        }();
        __webpack_exports__1 = __webpack_exports__1["default"];
        /******/ return __webpack_exports__1;
    /******/ }();
});
